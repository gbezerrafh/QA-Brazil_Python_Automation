...
class UrbanRoutesPage:
    ...
    def enter_from_location(self, from_text):
        WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(self.from_field))
        self.driver.find_element(*self.from_field).send_keys(from_text)

    def enter_to_location(self, to_text):
        WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(self.to_field))
    ...
    def get_from_location_value(self):
            return WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(self.from_field)).get_attribute('value')

    def get_to_location_value(self):
            return WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(self.to_field)).get_attribute('value')
    ...
    def click_number_text(self, telefone):
        ...
        code_input = WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(self.number_code))
        code_input.clear()
